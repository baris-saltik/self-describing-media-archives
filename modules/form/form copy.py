...
from wtforms.fields import StringField, PasswordField, IntegerField, SubmitField, BooleanField, IntegerRangeField, SelectField, FileField
...
def create_form(config = None):
    ...
    class MainForm(FlaskForm):
            ...
            _typeChoices = ['Galaxy', 'Enterprise', 'DDAE']
