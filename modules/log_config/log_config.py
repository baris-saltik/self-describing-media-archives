...
class LoggingConf(object):
    ...
    def __init__(self, logConfigPath = logConfigPath):
        ...
        try:
            ...
            print("There is no logging.yaml yet.")
    ...
    def create_logging_conf(self, dynamicPartDict = loggingDynamicPartDict):
        ...
        _staticItems = ["__main__", "sdma_web", "sdma_main"]
...
if __name__ == '__main__':
        ...
        loggingConfig.create_logging_conf(dynamicPartDict = loggingDynamicPartDict)
