...
# Defaults
fileList = [r"C:\Users\saltib\OneDrive - Dell Technologies\Documents\dokumanlar\resimler\sb\test_data\ski_dubai-1.jpg", 
             r"C:\Users\saltib\OneDrive - Dell Technologies\Documents\dokumanlar\resimler\sb\test_data\altinoluk1.jpg"]
    ...
    def get_labels(self, fileList = None):
        ...
        for filePath in fileList:
            try:
                ...
                for label in labels:
                    labeledFiles[filePath].append(label.description)
